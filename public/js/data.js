...
const _DEFAULTS = {
    activos: [
        {
            ...
            origen: "McDonald's Chapinero",
            destino: "Cra 13 #67-45, Chapinero",
            items: ["Big Mac x2", "Papas grandes", "Coca-Cola"],
            total: 52000,
            estado: "aceptado",
            tipo: "asap",
            hora: "Hace 8 min",
        ...
        },
        {
            ...
            origen: "Éxito Suba",
            destino: "Av. Suba #115-30, Suba",
            items: ["Mercado básico", "Productos de aseo"],
            total: 87000,
            estado: "en_camino",
            tipo: "asap",
            hora: "Hace 22 min",
        ...
        },
        {
            ...
            origen: "Farmacia Cruz Verde",
            destino: "Cll 100 #14-23, Usaquén",
            items: ["Medicamentos fórmula", "Vitaminas"],
            total: 34500,
            estado: "aceptado",
            tipo: "scheduled",
            hora: "12:30 PM",
    ...
    disponibles: [
        {
            ...
            origen: "Dominos Pizza Teusaquillo",
            destino: "Cra 24 #45-10, Teusaquillo",
            items: ["Pizza Personal", "Alitas x8", "Gaseosa 2L"],
            total: 68000,
            estado: "disponible",
            tipo: "asap",
            hora: "Ahora",
        ...
        },
        {
            ...
            origen: "Rappi Turbo Kennedy",
            destino: "Av. 68 #38-72, Kennedy",
            items: ["Encomienda pequeña"],
            total: 15000,
            estado: "disponible",
            tipo: "asap",
            hora: "Hace 2 min",
        ...
        },
        {
            ...
            origen: "Subway Engativá",
            destino: "Cll 68 #93-15, Engativá",
            items: ["Sub 30cm Pollo", "Sub 15cm Atún", "Cookies x2"],
            total: 45000,
            estado: "disponible",
            tipo: "scheduled",
            hora: "1:15 PM",
    ...
    historial: [
        {
            ...
            origen: "KFC Chapinero",
            destino: "Cra 11 #72-30",
            items: ["Balde familiar"],
            total: 74000,
            estado: "entregado",
            tipo: "asap",
            hora: "Hoy 10:15 AM",
        ...
        },
        {
            ...
            origen: "Presto Suba",
            destino: "Av. Suba #91-10",
            items: ["Combo 2 personas"],
            total: 38000,
            estado: "cancelado",
            tipo: "asap",
            hora: "Hoy 9:40 AM",
        ...
        },
        {
            ...
            origen: "Drogas La Rebaja",
            destino: "Cll 45 #27-18",
            items: ["Antibióticos", "Suero"],
            total: 22000,
            estado: "entregado",
            tipo: "asap",
            hora: "Hoy 9:05 AM",
        ...
        },
        {
            ...
            origen: "El Corral Usaquén",
            destino: "Cra 7 #115-40",
            items: ["Burger + Papas x3"],
            total: 93000,
            estado: "entregado",
            tipo: "asap",
            hora: "Ayer 7:30 PM",
    ...
    mensajes: [
        ...
        },
        {
            id: 2,
            de: "soporte",
            texto: "Recuerda que puedes reportar cualquier inconveniente con un pedido aquí.",
            hora: "9:01",
        },
    ],
};
...
function cambiarEstadoRepartidor() {
    ...
    localStorage.setItem("shizen_repartidor_activo", String(activo));
    actualizarBotonEstadoRepartidor();
    document.dispatchEvent(
        new CustomEvent("estadoRepartidorCambiado", { detail: { activo } }),
    );
    return activo;
}
...
function actualizarBotonEstadoRepartidor() {
    ...
    boton.querySelector(".nav-status-label").textContent = activo
        ? "Activo"
        : "Inactivo";
}
...
function countActivos() {
    return getActivos().filter(
        (p) => p.estado === "aceptado" || p.estado === "en_camino",
    ).length;
}
function cupoLleno() {
...
// Actions
function generarCodigoR(id) {
    return String(Math.floor(100000 + Math.random() * 900000));
}
function generarCodigoC(id) {
    return String(Math.floor(100000 + Math.random() * 900000));
}
...
function aceptarPedido(id) {
    ...
    const codR = generarCodigoR(id);
    const codC = generarCodigoC(id);
    activos.push({
        ...pedido,
        estado: "aceptado",
        codigo_r: codR,
...
function finalizarConCodigoCliente(id, codigoIngresado) {
    const activos = getActivos();
    const idx = activos.findIndex((p) => p.id === id);
    if (idx === -1) return { error: "Pedido no encontrado." };
    const p = activos[idx];
    const expected = p.codigo_c || "123456";
    if (codigoIngresado !== expected && codigoIngresado !== "123456") {
        return {
            error:
                "El código ingresado no coincide con el del cliente. Código de prueba: " +
                expected,
        };
    }
